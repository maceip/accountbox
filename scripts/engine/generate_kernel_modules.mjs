...
// scripts/engine/ -> repo root (the engine lives under src/engine/ in AccountBox).
...
const modules = [
  {
    outFile: 'src/engine/qwgpu/kernels.js',
    templateDir: 'src/engine/qwgpu/templates/forward',
    description: 'Forward/inference WGSL kernels.',
  },
  {
    outFile: 'src/engine/qwgpu/backward_kernels.js',
    templateDir: 'src/engine/qwgpu/templates/backward',
