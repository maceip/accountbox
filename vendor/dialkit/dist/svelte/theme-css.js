...
/* ── Dev feedback / agent notes ── */
.dialkit-feedback-highlight {
  outline: 2px solid #2563eb !important;
  outline-offset: 2px !important;
  cursor: crosshair !important;
}

.dialkit-feedback-selected {
  outline: 2px solid #f59e0b !important;
  outline-offset: 2px !important;
}

.dialkit-feedback-meta {
  font-size: 11px;
  color: var(--dial-text-secondary);
  margin-bottom: 8px;
}

.dialkit-feedback-field {
  display: flex;
  flex-direction: column;
  gap: 4px;
  margin-bottom: 8px;
...
.dialkit-feedback-select,
.dialkit-feedback-textarea {
  width: 100%;
  border: 1px solid var(--dial-border);
  border-radius: 8px;
  background: var(--dial-surface);
...
.dialkit-feedback-btn-primary {
  background: #2563eb !important;
  color: #fff !important;
}

.dialkit-feedback-btn-accent {
  background: #111827 !important;
  color: #fff !important;
}

.dialkit-feedback-status {
  margin-top: 8px;
  font-size: 11px;
  color: #059669;
}

.dialkit-feedback-notes {
  margin-top: 10px;
  display: flex;
  flex-direction: column;
  gap: 8px;
...
.dialkit-feedback-note-actions,
.dialkit-feedback-footer {
  display: flex;
  gap: 10px;
  margin-top: 8px;
  flex-wrap: wrap;
