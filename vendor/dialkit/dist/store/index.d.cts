...
export { type ActionConfig, type ColorConfig, type ControlMeta, type DialChangeEvent, type DialConfig, type DialKitPersistOptions, type DialKitValueUpdates, DialStore, type DialStorePanelOptions, type DialValue, type EasingConfig, type PanelConfig, type Preset, type ResolvedValues, type SelectConfig, type ShortcutConfig, type ShortcutInteraction, type ShortcutMode, type SpringConfig, type TextConfig, type TransitionConfig, flattenDialValueUpdates, resolveDialValues };
